...
{
    public class UsuariosAddController : Controller
    {
        private readonly SaboresCTX _context;

        public UsuariosAddController(SaboresCTX context)
        {
            _context = context;
        }
        ...
        // GET: UsuariosAdd/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: UsuariosAdd/Create
